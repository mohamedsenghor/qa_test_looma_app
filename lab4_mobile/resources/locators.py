...
# Product List Page
PRODUCT_LIST_SCROLL_CONTAINER = '//android.widget.FrameLayout[@resource-id="android:id/content"]/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View'
PRODUCT_LIST_TITLE = '//android.view.View[@content-desc="Liste des produits"]'
LAST_PRODUCT_AFTER_OPENING_PRODUCT_LIST = '//android.widget.ImageView[@content-desc="SanDisk SSD PLUS 1TB Internal SSD - SATA III 6 Gb/s\n109 $"]'
